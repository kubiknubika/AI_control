...
click на «Тест 2 · Гексовое поле 12×6»
  ...
  -> «Атаковать», «Исцелить отряд» или «Закончить ход»
  -> ход Демонов: движение к Рыцарям и атака при соседстве
  -> переход к следующему элементу расписания инициативы
```

В расписании одного цикла пять ходов Рыцарей и четыре хода Демонов. У каждого хода четыре очка действий; порядок виден в верхней полосе интерфейса.
