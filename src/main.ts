...
function test3UiIcon(type: Test3UiIcon): string {
  const icons: Record<Test3UiIcon, string> = {
    ...
    wood: '<g transform="rotate(-38 17 12)"><path class="test3-ui-wood-log" d="M8 7h17a4 4 0 0 1 0 8H8a4 4 0 0 1 0-8Z"/><ellipse class="test3-ui-wood-end" cx="25" cy="11" rx="4" ry="4"/><ellipse class="test3-ui-wood-ring" cx="25" cy="11" rx="1.8" ry="2"/><path class="test3-ui-wood-band" d="M13 7.7v6.6M18 7.2v7.6"/><path class="test3-ui-wood-highlight" d="M10 9h8"/></g><g transform="rotate(10 10 22)"><path class="test3-ui-wood-log" d="M8 18h15a4 4 0 0 1 0 8H8a4 4 0 0 1 0-8Z"/><ellipse class="test3-ui-wood-end" cx="8" cy="22" rx="4" ry="4"/><ellipse class="test3-ui-wood-ring" cx="8" cy="22" rx="1.8" ry="2"/><path class="test3-ui-wood-band" d="M17 18.3v7.4"/><path class="test3-ui-wood-highlight" d="M12 20h8"/></g><g transform="rotate(-8 21 22)"><path class="test3-ui-wood-log" d="M14 18h13a4 4 0 0 1 0 8H14a4 4 0 0 1 0-8Z"/><ellipse class="test3-ui-wood-end" cx="27" cy="22" rx="4" ry="4"/><ellipse class="test3-ui-wood-ring" cx="27" cy="22" rx="1.8" ry="2"/><path class="test3-ui-wood-band" d="M19 18.3v7.4"/><path class="test3-ui-wood-highlight" d="M17 20h8"/></g>',
    stone: '<path d="M4 23 7 14l7-5 7 2 7 8-3 8H9L4 23Z"/><path d="m7 14 7 5 7-4M14 19l-2 8M21 15l4 4"/>',
    food: '<path class="test3-ui-food-loaf" d="M5 20c0-6 5-10 11-10s11 4 11 9c0 4-3 8-8 9H12c-4 0-7-3-7-8Z"/><path class="test3-ui-food-score" d="M10 17c1-2 2-2 3 0M15 14c1-2 2-2 3 0M20 17c1-2 2-2 3 0"/><path class="test3-ui-food-crust" d="M8 23c4 2 12 2 16-1"/><circle class="test3-ui-food-crumb" cx="10" cy="21" r="0.8"/><circle class="test3-ui-food-crumb" cx="23" cy="22" r="0.8"/>',
...
function test3BuildingIcon(type: Test3BuildingType): string {
  const icons: Record<Test3BuildingType, string> = {
    ...
    house: '<path d="M22 13V4h4v9M21 4h6"/><path d="M6 15h20v13H6V15Z"/><path class="test3-icon-roof" d="M3 16 16 4l13 12M5 16h22"/><path d="M13 28v-8h6v8M8 18h3v3H8zM21 18h3v3h-3zM9.5 18v3M8 19.5h3M22.5 18v3M21 19.5h3M16 24h1"/>',
    ...
    barracks: '<path d="M3 12h26v16H3V12Z"/><path d="M3 12h26M7 17h3v5H7zM22 17h3v5h-3zM16 4v8M16 4h6l-3 3h3"/><path class="test3-icon-shield" d="M16 14 21 17v4c0 3-2 5-5 7-3-2-5-4-5-7v-4l5-3Z"/>',
