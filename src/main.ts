...
function test3UiIcon(type: Test3UiIcon): string {
  const icons: Record<Test3UiIcon, string> = {
    ...
    wood: '<path class="test3-ui-wood-log" d="M18 4h8c2 0 3 2 3 4s-1 4-3 4h-8c-2 0-3-2-3-4s1-4 3-4Z"/><ellipse class="test3-ui-wood-end" cx="18" cy="8" rx="4" ry="4"/><ellipse class="test3-ui-wood-ring" cx="18" cy="8" rx="1.8" ry="2"/><path class="test3-ui-wood-log" d="M7 14h8c2 0 3 2 3 4s-1 4-3 4H7c-2 0-3-2-3-4s1-4 3-4Z"/><ellipse class="test3-ui-wood-end" cx="7" cy="18" rx="4" ry="4"/><ellipse class="test3-ui-wood-ring" cx="7" cy="18" rx="1.8" ry="2"/><path class="test3-ui-wood-log" d="M19 17h8c2 0 3 2 3 4s-1 4-3 4h-8c-2 0-3-2-3-4s1-4 3-4Z"/><ellipse class="test3-ui-wood-end" cx="19" cy="21" rx="4" ry="4"/><ellipse class="test3-ui-wood-ring" cx="19" cy="21" rx="1.8" ry="2"/>',
