...
function test3UiIcon(type: Test3UiIcon): string {
  const icons: Record<Test3UiIcon, string> = {
    ...
    wood: '<g transform="rotate(-28 17 12)"><path class="test3-ui-wood-log" d="M12 7h13c2 0 3 2 3 4s-1 4-3 4H12c-2 0-3-2-3-4s1-4 3-4Z"/><ellipse class="test3-ui-wood-end" cx="12" cy="11" rx="4" ry="4"/><ellipse class="test3-ui-wood-ring" cx="12" cy="11" rx="1.8" ry="2"/></g><g transform="rotate(7 10 22)"><path class="test3-ui-wood-log" d="M8 18h13c2 0 3 2 3 4s-1 4-3 4H8c-2 0-3-2-3-4s1-4 3-4Z"/><ellipse class="test3-ui-wood-end" cx="8" cy="22" rx="4" ry="4"/><ellipse class="test3-ui-wood-ring" cx="8" cy="22" rx="1.8" ry="2"/></g><g transform="rotate(-4 21 22)"><path class="test3-ui-wood-log" d="M18 18h11c2 0 3 2 3 4s-1 4-3 4H18c-2 0-3-2-3-4s1-4 3-4Z"/><ellipse class="test3-ui-wood-end" cx="18" cy="22" rx="4" ry="4"/><ellipse class="test3-ui-wood-ring" cx="18" cy="22" rx="1.8" ry="2"/></g>',
