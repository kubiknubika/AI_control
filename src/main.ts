...
function test3UiIcon(type: Test3UiIcon): string {
  const icons: Record<Test3UiIcon, string> = {
    ...
    wood: '<g transform="rotate(-32 8 22)"><path class="test3-ui-wood-log" d="M8 18h13a4 4 0 0 1 0 8H8a4 4 0 0 1 0-8Z"/><ellipse class="test3-ui-wood-end" cx="8" cy="22" rx="4" ry="4"/><ellipse class="test3-ui-wood-ring" cx="8" cy="22" rx="1.8" ry="2"/><path class="test3-ui-wood-band" d="M16 18.3v7.4"/><path class="test3-ui-wood-highlight" d="M11 20h7"/></g><g transform="rotate(32 27 22)"><path class="test3-ui-wood-log" d="M15 18h12a4 4 0 0 1 0 8H15a4 4 0 0 1 0-8Z"/><ellipse class="test3-ui-wood-end" cx="27" cy="22" rx="4" ry="4"/><ellipse class="test3-ui-wood-ring" cx="27" cy="22" rx="1.8" ry="2"/><path class="test3-ui-wood-band" d="M19 18.3v7.4"/><path class="test3-ui-wood-highlight" d="M18 20h7"/></g><g transform="rotate(-38 26 9)"><path class="test3-ui-wood-log" d="M7 5h19a4 4 0 0 1 0 8H7a4 4 0 0 1 0-8Z"/><ellipse class="test3-ui-wood-end" cx="26" cy="9" rx="4" ry="4"/><ellipse class="test3-ui-wood-ring" cx="26" cy="9" rx="1.8" ry="2"/><path class="test3-ui-wood-band" d="M13 5.7v6.6M18 5.2v7.6"/><path class="test3-ui-wood-highlight" d="M9 7h9"/></g>',
