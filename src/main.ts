...
function test3UiIcon(type: Test3UiIcon): string {
  const icons: Record<Test3UiIcon, string> = {
    ...
    wood: '<path class="test3-ui-wood-log" d="M9 4h15c2 0 3 1 3 4s-1 4-3 4H9c-2 0-3-1-3-4s1-4 3-4Z"/><ellipse class="test3-ui-wood-end" cx="9" cy="8" rx="3.5" ry="3.5"/><ellipse class="test3-ui-wood-ring" cx="9" cy="8" rx="1.5" ry="1.5"/><path class="test3-ui-wood-log" d="M7 12h17c2 0 3 1 3 4s-1 4-3 4H7c-2 0-3-1-3-4s1-4 3-4Z"/><ellipse class="test3-ui-wood-end" cx="7" cy="16" rx="3.5" ry="3.5"/><ellipse class="test3-ui-wood-ring" cx="7" cy="16" rx="1.5" ry="1.5"/><path class="test3-ui-wood-log" d="M9 20h15c2 0 3 1 3 4s-1 4-3 4H9c-2 0-3-1-3-4s1-4 3-4Z"/><ellipse class="test3-ui-wood-end" cx="9" cy="24" rx="3.5" ry="3.5"/><ellipse class="test3-ui-wood-ring" cx="9" cy="24" rx="1.5" ry="1.5"/>',
    stone: '<path d="M4 23 7 14l7-5 7 2 7 8-3 8H9L4 23Z"/><path d="m7 14 7 5 7-4M14 19l-2 8M21 15l4 4"/>',
    food: '<path class="test3-ui-food-loaf" d="M5 19c0-5 5-9 11-9s11 4 11 9c0 5-5 8-11 8S5 24 5 19Z"/><path d="m11 16 3 2M16 13l3 2M21 16l3 2"/>',
